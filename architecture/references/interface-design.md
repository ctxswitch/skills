...
Use both [language.md](./language.md) vocabulary and the codebase's own domain terms so every design names things consistently with the architecture language and the project's domain language.
