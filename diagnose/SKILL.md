...
When exploring the codebase, read `AGENTS.md` if it exists, then use the project's own vocabulary to get a clear mental model of the relevant modules, and check the decisions documented in the area you're touching.
